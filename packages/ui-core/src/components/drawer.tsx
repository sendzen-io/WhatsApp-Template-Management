...
interface DrawerContentProps
  extends Omit<
    ModalOverlayProps,
    "className" | "children" | "isDismissable" | "onAnimationStart" | "style"
  >,
...
const DrawerContent = ({
  ...
  const state = use(OverlayTriggerStateContext)! as DrawerOverlayState
        ...
        >
          {() => (
            <DrawerRoot
              ...
              onDragEnd={(_: unknown, { offset, velocity }: DrawerDragInfo) => {
...
type DrawerTitleProps = HeadingProps & { className?: string }
...
type DrawerDescriptionProps = TextProps & { className?: string }
...
const DrawerClose = ({ className, variant = "outline", ref, ...props }: ButtonProps) => {
